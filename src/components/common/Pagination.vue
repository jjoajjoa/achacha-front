<template>
    ...
    <ul class="pagination pagination-circle pagination-outline">
        ...
        <li v-else="pagination.page == 1" class="page-item previous m-1"
        ...
        <li v-for="item in pagination.pages" :key="item.pageNo" class="page-item m-1"
            :class="(item.pageActive) ? 'active' : ''">
            <a v-if="item.pageActive" href="#" class="page-link">{{ item.pageNo }}</a>
            <a v-else @click="requestFunc(item.pageNo, pagination.perPage)" href="#" class="page-link">{{ item.pageNo
                }}</a>
        </li>
        ...
        <li v-else="pagination.page >= pagination.pageCount" class="page-item last m-1"
